      ...
      tabsetPanel(type = "tabs",
                  tabPanel("华为云",     fluidRow(
                    tabsetPanel(type = "tabs",
                                ...
                                tabPanel("企业集成平台ROMA", tableOutput("table")),
                                tabPanel("AI开发平台 ModelArts", tableOutput("table")),
                                tabPanel("对象存储 OBS", tableOutput("table")),
                                tabPanel("智能数据湖运营平台 DAYU", tableOutput("table")),
                                tabPanel("区块链服务 BCS", tableOutput("table")),
                                tabPanel("分布式缓存服务 Redis", tableOutput("table")),
